...
Provisional Tauri 2 composition root for the shared `@coredrill/web` frontend. Rust remains a thin privileged boundary, and D-022 remains Provisional until `NAT-005` through `NAT-008` close the secure-store, native export/restore, packaging, and remaining platform gates.
