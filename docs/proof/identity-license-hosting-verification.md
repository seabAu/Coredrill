...
| --------- | ---------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `FND-001` | Partially proven | All required governance paths remain present; the repository now uses the canonical Apache License 2.0 text, root package metadata declares `Apache-2.0`, and `D-054`/`D-055` record the owner's Coredrill/license decisions. The checklist stays open because no durable private conduct or vulnerability-reporting route has been published. |
...
- The repository is public. Public visibility does not open contribution intake or resolve the missing private conduct and vulnerability-reporting routes. The public Security page exposes the interim `SECURITY.md` instructions but no private vulnerability-reporting entry point.
...
1. Publish durable private conduct and vulnerability-reporting routes before marking `FND-001` complete or opening external contributions/public distribution. One address may cover both only if both policies clearly name it and the enforcement/conflict process remains adequate.
