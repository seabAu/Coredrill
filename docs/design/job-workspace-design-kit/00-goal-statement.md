...
- **One calm workspace:** the current job, its next action, evidence, documents, people, and history stay together.
- **Private by default:** core data remains in the user's selected browser or desktop vault.
- **Truth before fluency:** the system never improves prose by inventing experience.
- **Explainable assistance:** extracted fields, fit analysis, salary ranges, and generated claims show their sources and uncertainty.
- **Automation with a hand on the wheel:** capture and drafting are accelerated; submission, outreach, and sensitive answers remain user-controlled.
- **Portable ownership:** complete export, backup, restore, and deletion are product features, not support procedures.

## North-star outcome

The user spends less time reconstructing context and retyping facts, and more time deciding whether a role is worthwhile and presenting their real experience clearly.
