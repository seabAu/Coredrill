...
Current work item: `NAT-006` through `NAT-008` — export/recovery, packaging proof, and evidence-backed native-adapter decision
...
|---|---|
| Milestone | Phase 0 |
| Item range | `NAT-006` through `NAT-008` |
| Branch/worktree | `main` / repository root |
| Started | 2026-08-24 |
| Expected proof | Checksummed picker-driven export/restore with atomic replacement; installable first-OS artifact and resource benchmark; ADR-backed D-022/D-024/Q-003 decision |
