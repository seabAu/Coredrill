...
Provisional decisions `D-010`, `D-012`, `D-015`, `D-022`, `D-023`, and `D-027` retain their named Phase 0/usability gates. ADR-0003 promotes D-025 after exact hosted browser lanes passed and resolves Q-002 with an explicit unsupported-platform fallback. Deferred `D-052` does not authorize a sync service or account dependency.
