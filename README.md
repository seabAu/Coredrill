...
Job Workspace is a standalone, local-first workspace for capturing job opportunities, managing an application pipeline, grounding application materials in truthful career evidence, and making explainable decisions about where to focus.
...
The concise product outcome is in the [goal statement](docs/design/job-workspace-design-kit/00-goal-statement.md). The full execution charter is [GOAL.md](docs/design/job-workspace-design-kit/GOAL.md).
...
2. [Product goal](docs/design/job-workspace-design-kit/GOAL.md)
3. [ADR index](docs/adr/README.md) and [decision register](docs/design/job-workspace-design-kit/11-decision-register.md)
...
The public software-license/business-model decision is intentionally unresolved as design question `Q-013`. Until the owner selects a license, the temporary [LICENSE](LICENSE) notice grants no rights and preserves all options. External contributions are not accepted during this interval.
